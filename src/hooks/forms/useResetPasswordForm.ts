...
import { ResetPasswordFormSchema } from '@/shared/validation/authSchemas';
...
export function useResetPasswordForm(mode: 'onBlur' | 'onChange' | 'onSubmit' = 'onBlur') {
	const form = useFormWithSchema(ResetPasswordFormSchema, ResetPasswordFormSchema.parse({}), mode);
